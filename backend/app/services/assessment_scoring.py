...
def calculate_tki_score(answers: List[AssessmentAnswer]) -> Dict[str, Any]:
    ...
    - Compromising (CM)
    """
    # TKI question mappings (from Excel document)
    # Format: {question_id: {"A": mode, "B": mode}}
    tki_mappings = {
        "tki_q1": {"A": "competing", "B": "collaborating"},
        "tki_q2": {"A": "collaborating", "B": "avoiding"},
        "tki_q3": {"A": "competing", "B": "accommodating"},
        "tki_q4": {"A": "avoiding", "B": "collaborating"},
        "tki_q5": {"A": "accommodating", "B": "competing"},
        "tki_q6": {"A": "collaborating", "B": "compromising"},
        "tki_q7": {"A": "avoiding", "B": "accommodating"},
        "tki_q8": {"A": "competing", "B": "collaborating"},
        "tki_q9": {"A": "accommodating", "B": "avoiding"},
        "tki_q10": {"A": "competing", "B": "compromising"},
        "tki_q11": {"A": "collaborating", "B": "accommodating"},
        "tki_q12": {"A": "competing", "B": "avoiding"},
        "tki_q13": {"A": "compromising", "B": "collaborating"},
        "tki_q14": {"A": "avoiding", "B": "competing"},
        "tki_q15": {"A": "accommodating", "B": "collaborating"},
        "tki_q16": {"A": "competing", "B": "compromising"},
        "tki_q17": {"A": "collaborating", "B": "avoiding"},
        "tki_q18": {"A": "accommodating", "B": "competing"},
        "tki_q19": {"A": "avoiding", "B": "compromising"},
        "tki_q20": {"A": "competing", "B": "collaborating"},
        "tki_q21": {"A": "compromising", "B": "accommodating"},
        "tki_q22": {"A": "collaborating", "B": "competing"},
        "tki_q23": {"A": "avoiding", "B": "accommodating"},
        "tki_q24": {"A": "competing", "B": "collaborating"},
        "tki_q25": {"A": "accommodating", "B": "avoiding"},
        "tki_q26": {"A": "compromising", "B": "competing"},
        "tki_q27": {"A": "collaborating", "B": "accommodating"},
        "tki_q28": {"A": "avoiding", "B": "competing"},
        "tki_q29": {"A": "accommodating", "B": "compromising"},
        "tki_q30": {"A": "competing", "B": "collaborating"},
    }
