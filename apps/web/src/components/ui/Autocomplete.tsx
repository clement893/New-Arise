 ...
 * Searchable input with suggestions dropdown
 */
...
const defaultFilterOptions = (options: AutocompleteOption[], searchTerm: string): AutocompleteOption[] => {
        ...
        {isOpen && filteredOptions.length > 0 && (
          <div
            ...
            className={clsx(
              ...
              'border border-gray-200 dark:border-gray-700 rounded-lg shadow-strong',
              'overflow-y-auto',
              maxHeight,
              dropdownClassName
            )}
