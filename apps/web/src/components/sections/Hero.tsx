  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center bg-gradient-to-br from-primary-50 via-primary-100 to-primary-200 dark:from-muted dark:via-muted dark:to-muted overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-4 sm:px-6 py-12 sm:py-20 text-center">
        ...
        <h1 className="text-4xl sm:text-5xl md:text-7xl lg:text-8xl font-bold text-foreground mb-4 sm:mb-6 leading-[1.1] px-2 animate-fade-in" style={{ animationDelay: '0.1s' }}>
        ...
        <p className="text-base sm:text-lg md:text-xl lg:text-2xl text-muted-foreground mb-8 sm:mb-12 max-w-3xl mx-auto leading-relaxed px-2 font-medium animate-fade-in" style={{ animationDelay: '0.2s' }}>
        ...
        <div className="flex flex-wrap items-center justify-center gap-4 sm:gap-8 text-xs sm:text-sm text-muted-foreground px-2" role="list" aria-label="Caractéristiques principales">
