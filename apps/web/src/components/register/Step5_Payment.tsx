              ...
              <>
                ...
                <div className="relative">
                  <form onSubmit={handleSubmit} className="space-y-4">
                    {/* Test Card Information for MVP */}
                    <div className="bg-blue-50 border-2 border-blue-300 rounded-lg p-4 mb-4">
                      <p className="text-sm font-semibold text-blue-900 mb-2">🧪 MVP Test Card Information:</p>
                      <div className="text-xs text-blue-800 space-y-1">
                        <p><strong>Card Number:</strong> 4242 4242 4242 4242</p>
                        <p><strong>Expiry Date:</strong> 01/30</p>
                        <p><strong>CVV:</strong> 565</p>
                        <p className="mt-2 text-blue-700 italic">Please enter these test card details in the form below.</p>
                      </div>
                    </div>
...
export function Step5_Payment() {
  // Always use Stripe Elements for secure card collection (PCI compliant)
  return (
    <Elements 
