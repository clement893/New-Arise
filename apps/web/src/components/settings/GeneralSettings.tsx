 ...
 * Includes basic settings like language, timezone, theme, etc.
 * 
 * @component
 * @example
 * ```tsx
 ...
 * General Settings Component
 * 
 * Displays form for general application settings including language, timezone, theme, etc.
 */
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <Select
              ...
              onChange={(value) => setFormData({ ...formData, timeFormat: String(value) as '12h' | '24h' })}
          ...
          <div>
            ...
            <Select
              ...
              onChange={(value) => setFormData({ ...formData, weekStartsOn: String(value) as 'monday' | 'sunday' })}
        ...
        <div className="space-y-4">
          <div>
            ...
            <Select
              ...
              onChange={(value) => setFormData({ ...formData, theme: String(value) as 'light' | 'dark' | 'system' })}
        ...
        <div className="space-y-4">
          <div className="flex items-center justify-between">
            ...
            <Switch
              ...
              onChange={(checked) => setFormData({ ...formData, enableNotifications: Boolean(checked) })}
            />
          </div>
          ...
          <div className="flex items-center justify-between">
            ...
            <Switch
              ...
              onChange={(checked) => setFormData({ ...formData, enableEmailNotifications: Boolean(checked) })}
            />
          </div>
        </div>
      </Card>
