 ...
 * 
 * Navigation component for settings pages with links to different settings sections.
 * Displays a grid of setting cards that link to respective settings pages.
 * 
 * @component
 * @example
 * ```tsx
 ...
 * Settings Navigation Component
 * 
 * Displays a grid of setting cards for navigation to different settings pages.
 */
export default function SettingsNavigation({ className }: SettingsNavigationProps) {
  ...
  const navItems: SettingsNavItem[] = [
    ...
    },
    {
      ...
      description: t('navigation.organizationDescription') || 'Organization name, logo, and domain settings',
    },
    {
      id: 'team',
    ...
    },
    {
      ...
      description: t('navigation.integrationsDescription') || 'Third-party integrations and connections',
    },
    {
      id: 'api',
