...
export default function CompanyFilterBadges({ filters, onRemoveFilter, onClearAll }: CompanyFilterBadgesProps) {
  const hasFilters = (filters.country && filters.country.length > 0) ||
