...
export default function ContactFilterBadges({ filters, onRemoveFilter, onClearAll }: ContactFilterBadgesProps) {
  const hasFilters = (filters.city && filters.city.length > 0) ||
