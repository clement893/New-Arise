...
export default function RoleDefaultPermissionsEditor({ onUpdate }: RoleDefaultPermissionsEditorProps) {
  ...
  const renderPermissionsList = useCallback((permsToShow: Permission[]) => {
                ...
                <div key={perm.id} className="flex items-start space-x-3">
                  <Checkbox
                    ...
                    onCheckedChange={(checked) => {
                      ...
                      } else if (checked && selectedRolePermissionIds.has(
              ...
              {roles.map(role => (
                ...
                >
                  <div className="text-left">
                    ...
                    {role.is_system && (
                      <Badge variant="info" className="text-xs mt-1">{t('systemRole')}</Badge>
                    )}
                  </div>
                </Button>
              ))}
            ...
            <>
              ...
              <Tabs defaultTab={activeTab} onChange={(tabId) => setActiveTab(tabId as typeof activeTab)}>
                <TabList className="mb-4">
                  ...
                  <Tab value="permissions">{t('tabs.permissions')} ({permissionPermissions.length})</Tab>
                </TabList>
